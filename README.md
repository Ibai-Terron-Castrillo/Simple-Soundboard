...
- Hotkeys globales.
- Bancos o paginas de sonidos.
- Importacion/exportacion de configuracion.
- Volumen individual por sonido.
- Iconos personalizados por categoria.
- Instalador MSI o MSIX.
- Tests automatizados para escaneo y API.
